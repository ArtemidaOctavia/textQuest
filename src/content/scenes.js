const scenes = {
  ...
  woodScene: {
    ...
    description: 'Лес — экологическая система, биоценоз, в которой главной жизненной формой являются деревья '
        ...
        + 'редколесьем.',
    image: 'https://m1.35photo.pro/photos_col/r2/264/1321723_500r.jpg',
    actions: {
      forward: {
  ...
  gardenScene: {
    ...
    image: 'https://i.pinimg.com/originals/ac/bd/11/acbd11d4d9669fec46416d2d19f6b4d8.jpg',
    actions: {
      forward: {
        actionDescription: 'Идти вперёд',
        effects: [
  ...
  riverScene: {
    ...
    description: 'Река — природный водный поток значительных размеров с естественным течением по руслу '
        ...
        + 'водохранилища (проточные озёра либо искусственные моря).',
    image: 'https://images11.popmeh.ru/upload/img_cache/2c9/2c90da0cd465acefe59f52db611e4662_ce_400x400x150x0_cropped_800x800.jpg',
    actions: {
      forward: {
        actionDescription: 'Идти вперёд',
        effects: [
  ...
  youDiedScene: {
    ...
    image: 'https://i.ibb.co/pQKym9t/avatars-000594607302-s98d2j-t500x500.jpg',
    actions: {
      newGame: {
